...
namespace Sistema.Areas.Admin.Controllers
{
    ...
    public class ClientController : Controller
    {
        ...
        public ClientController(SistemaDbContext context, IUserHelper userHelper)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<IActionResult> NewAppointment(CreateAppointmentViewModel model)
        {
