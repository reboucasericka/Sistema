...
namespace Sistema.Areas.Admin.Controllers
{
    ...
    public class ProfessionalsController : Controller
    {
        ...
        public ProfessionalsController(SistemaDbContext context, IImageHelper imageHelper, IUserHelper userHelper)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create(Professional professional, IFormFile? photoFile, string? email, string? password)
        {
            try
            {
                ...
                {
                    professional.PhotoPath = await _imageHelper.UploadImageAsync(photoFile, "professionals");
                }
