...
namespace Sistema.Areas.Public.Controllers
{
    ...
    public class PublicProfessionalProfileController : Controller
    {
        private readonly SistemaDbContext _context;
        private readonly IUserHelper _userHelper;
        private readonly IConverterHelper _converterHelper;

        public PublicProfessionalProfileController(SistemaDbContext context, IUserHelper userHelper, IConverterHelper converterHelper)
        {
            _context = context;
        ...
        public async Task<IActionResult> Edit(ProfessionalProfileEditViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                professional.ImageId = Guid.Parse(model.ImageId ?? Guid.Empty.ToString());
