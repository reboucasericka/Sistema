...
namespace Sistema.Areas.Public.Controllers
{
    ...
    public class ProfileController : Controller
    {
        ...
        public ProfileController(SistemaDbContext context, IConverterHelper converterHelper, IUserHelper userHelper)
        {
            _context = context;
        ...
        public async Task<IActionResult> Edit(CustomerProfileEditViewModel model)
        {
